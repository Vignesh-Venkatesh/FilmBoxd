...
usersRoutes.post("/:username/watched", authMiddleware, async (c) => {
...
usersRoutes.delete("/:username/watched", authMiddleware, async (c) => {
...
usersRoutes.post("/:username/watchlist", authMiddleware, async (c) => {
  // getting user info from session and URL param
  const user = c.get("user");
  const username = c.req.param("username");
...
usersRoutes.delete("/:username/watchlist", authMiddleware, async (c) => {
  // getting user info from session and URL param
  const user = c.get("user");
  const username = c.req.param("username");
...
usersRoutes.post("/:username/favorites", authMiddleware, async (c) => {
  // getting user info from session and URL param
  const user = c.get("user");
  const username = c.req.param("username");
...
usersRoutes.delete("/:username/favorites", authMiddleware, async (c) => {
  // getting user info from session and URL param
  const user = c.get("user");
  const username = c.req.param("username");
