    ...
    async function fetchWatchlist() {
      try {
        ...
        const res = await fetch(
          `${URL}/user/${username}/watchlist?page=${page}`
        );
        const json = await res.json();

        if (!res.ok) throw new Error(json.msg || "Failed to fetch watchlist");
        ...
        setWatchlist(movies.filter((m) => m !== null));
    ...
    return (
      <div>
        ...
        <div className="w-[950px] mx-auto py-[30px]">
          <h1 className="text-lg font-bold">{username}'s Watchlisted Films</h1>
    ...
    <div>
      ...
      <div className="w-[950px] mx-auto py-[30px]">
        ...
        {watchlist.length === 0 ? (
          ...
          <>
            {/* poster grid */}
            <SmallList data={watchlist} columns={12} />
